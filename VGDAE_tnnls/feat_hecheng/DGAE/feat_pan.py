...
def comput_cor(args):
    ...
    model.load_state_dict(torch.load('syn_data.pth'))
...
def cor_fig(cor, args):
    ...
    plt.savefig('feat.eps', bbox_inches='tight', pad_inches=0.1, dpi=800)
    plt.savefig('feat.png', bbox_inches='tight', pad_inches=0.1, dpi=800)
