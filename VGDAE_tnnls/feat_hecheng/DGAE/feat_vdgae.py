...
def comput_cor(args):
    ...
    model.load_state_dict(torch.load('syn_data_epoch_51000.pth', map_location='cuda:0'))
...
def cor_fig(cor, args):
    ...
    plt.savefig('feat_vdgae.pdf', bbox_inches='tight', pad_inches=0.1, dpi=800)
    plt.savefig('feat_vdgae.png', bbox_inches='tight', pad_inches=0.1, dpi=800)
