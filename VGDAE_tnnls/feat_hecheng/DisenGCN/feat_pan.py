...
def comput_cor(args):
    ...
    model.load_state_dict(torch.load('syn_disengcn.pth'))
...
def cor_fig(cor, args):
    ...
    plt.savefig('feat_disengcn.eps', bbox_inches='tight', pad_inches=0.1, dpi=800)
    plt.savefig('feat_disengcn.png', bbox_inches='tight', pad_inches=0.1, dpi=800)
