...
def comput_cor(args):
    ...
    model.load_state_dict(torch.load('sys_disengcn.pth'))
...
def cor_fig(cor, args):
    ...
    plt.savefig('feat_disengcn.pdf', bbox_inches='tight', pad_inches=0.1, dpi=1500)
    plt.savefig('feat_disengcn.png', bbox_inches='tight', pad_inches=0.1, dpi=1500)
