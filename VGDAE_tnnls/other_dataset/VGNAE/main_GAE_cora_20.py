...
def get_args():
    ...
    parser.add_argument('--test_frac', type=float, default=0.75,help='fraction of edges for testing set')
    parser.add_argument('--train_frac', type=str, default='20',help='fraction of edges for testing set')
...
def main(args):
    log_name = f'{args.log_dir}/{args.name}_{args.dataset}_{args.train_frac}_{args.model}_{time.strftime("%Y-%m-%d,%H-%M")}'
