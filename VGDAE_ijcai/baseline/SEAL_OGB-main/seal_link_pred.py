...
parser.add_argument('--train_percent', type=float, default=85)
parser.add_argument('--val_percent', type=float, default=5)
parser.add_argument('--test_percent', type=float, default=10)
